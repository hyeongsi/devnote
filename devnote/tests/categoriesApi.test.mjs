...
const sourcePath = new URL('../src/api/categories.ts', import.meta.url);
...
const outputDir = join(tmpdir(), 'devnote-category-tests');
const outputPath = join(outputDir, `categories-${Date.now()}.mjs`);
